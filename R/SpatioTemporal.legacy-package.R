...
##' Sampson et.al., 2011; Lindstr�m et.al., 2010). The package also
##' contains functions that handle missing data SVD in accordance with
##' (Fuentes et.al. 2006).
##' \cr
##' \tabular{ll}{
##'   Package: \tab SpatioTemporal.legacy\cr
##'   Type: \tab Package\cr
##'   Version: \tab 1.1.7\cr
...
##' 
##' @name SpatioTemporal.legacy-package
##' @aliases SpatioTemporal.legacy-package SpatioTemporal.legacy
##' @docType package
...
##' \cr
##' Travel for J. Lindstr�m has been paid by STINT (The
...
##' }
##' 
##' @author Johan Lindstr�m, Adam Szpiro, Paul D. Sampson,
...
##' 
##' J. Lindstr�m, A. Szpiro, P. D. Sampson, L. Sheppard, A. Oron,
...
##'   21, 606-631.
##'
##' P. D. Sampson, A. Szpiro, L. Sheppard, J. Lindstr�m, J. D.  Kaufman. (2011)
